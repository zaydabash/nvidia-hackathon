...
Takes a health concern, location, and insurance status
Runs 4 parallel web searches for real local resources
Reasons over results using NVIDIA Nemotron 49B
Streams a personalized action plan with names, addresses, phone numbers
Generates a phone call script so users know exactly what to say
Answers follow-up questions in full context
Features
...
NVIDIA NIM	build.nvidia.com	Yes
Tavily	app.tavily.com	For web search
